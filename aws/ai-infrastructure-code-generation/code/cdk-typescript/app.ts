        ...
        TemplateProcessingPolicy: new iam.PolicyDocument({
          statements: [
            ...
            new iam.PolicyStatement({
              ...
              resources: [templateBucket.bucketArn, `${templateBucket.bucketArn}/*`],
            }),
            // CloudFormation permissions for template validation and stack operations
            // NOTE: Removed cloudformation:CreateStack to mitigate privilege escalation via CreateStack.
            new iam.PolicyStatement({
              effect: iam.Effect.ALLOW,
              actions: [
            ...
            // SECURITY FIX: Removed iam:PassRole to mitigate privilege escalation via PassRole.
            new iam.PolicyStatement({
              effect: iam.Effect.ALLOW,
              actions: ['iam:CreateRole', 'iam:AttachRolePolicy', 'iam:GetRole', 'iam:ListRoles'],
              resources: ['*'],
            }),
