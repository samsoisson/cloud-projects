...
class QDeveloperInfrastructureStack(Stack):
    ...
    def _create_lambda_execution_role(self, suffix: str) -> iam.Role:
        ...
        # Restrict IAM privilege escalation vector by removing broad IAM management permissions.
        # Lambda only needs to pass roles to CloudFormation when required.
        # NOTE: Removed iam:PassRole permission to eliminate privilege escalation risk.
        return role
