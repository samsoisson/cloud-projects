  ...
  private createLambdaFunctions(
    ...
    const orchestratorFunction = new lambda.Function(this, 'BCTestOrchestratorFunction', {
      ...
      environment: {
        ...
        RESULTS_BUCKET_OWNER: this.account,
...
def lambda_handler(event, context):
    ...
    try:
        ...
        s3.put_object(
            ...
            ExpectedBucketOwner=os.environ['RESULTS_BUCKET_OWNER']
        )
...
const enableSchedulingContext = app.node.tryGetContext('enableScheduling');
const enableScheduling = enableSchedulingContext === undefined
  ? true
  : String(enableSchedulingContext).toLowerCase() !== 'false';
