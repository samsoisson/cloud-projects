...
export class CanaryDeploymentStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: CanaryDeploymentStackProps = {}) {
    ...
    // NOTE: Removed broad lambda:InvokeFunction permission to avoid privilege escalation vector.
    // VPC Lattice invoke permissions are handled via Lambda resource-based policies (addPermission below).
...
`),
    ...
    // Grant VPC Lattice permission to invoke Lambda functions (resource-based policies)
