...
export class CanaryDeploymentStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: CanaryDeploymentStackProps = {}) {
    ...
    // NOTE: Removed broad lambda:InvokeFunction permission from the execution role to prevent privilege escalation.
    // VPC Lattice invoke permissions are granted via resource-based Lambda permissions below.
