...
class ServiceCatalogPortfolioStack(Stack):
    ...
    def _create_launch_role(self, suffix: str) -> iam.Role:
        ...
        # Restrict permissions to reduce privilege escalation risk.
        # Avoid broad wildcard resource permissions.
        launch_policy = iam.PolicyDocument(
            statements=[
                # Read-only/list permissions required for template execution and resource discovery
                iam.PolicyStatement(
                ...
                # S3 bucket management limited to buckets created by this portfolio's templates.
                iam.PolicyStatement(
                    effect=iam.Effect.ALLOW,
                    actions=[
                        "s3:CreateBucket",
                ...
                # Lambda function management limited to functions created by this portfolio's templates.
                iam.PolicyStatement(
                    effect=iam.Effect.ALLOW,
                    actions=[
                ...
                # IAM role management limited to roles created by this portfolio's templates.
                iam.PolicyStatement(
                    effect=iam.Effect.ALLOW,
                    actions=[
                        "iam:CreateRole",
