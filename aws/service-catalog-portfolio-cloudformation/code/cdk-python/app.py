...
class ServiceCatalogPortfolioStack(Stack):
    ...
    def _create_launch_role(self, suffix: str) -> iam.Role:
        ...
        # Restrict permissions to avoid privilege escalation via overly-broad IAM permissions.
        # Specifically, do not allow creating/attaching arbitrary IAM roles/policies or PassRole.
